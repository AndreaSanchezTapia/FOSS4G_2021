...
+ Flexibility to start and leave at any step is essential to guarantee the communication with other packages and the fleibility that different projects require

--

+ It is not a problem to have one more package if it integrates well with other packages

---
## To improve reproducibility:

+ Use script-based applications (programming languages)
